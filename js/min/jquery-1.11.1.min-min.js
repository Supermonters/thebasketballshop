!(function (e, t) {
  ...
  function o(e) {
    var t = (wt[e] = {});
    return (
      ot.each(e.match(xt) || [], function (e, n) {
        t[n] = !0;
      }),
      t
    );
  ...
  function a() {
    mt.addEventListener
      ...
      : (mt.detachEvent("onreadystatechange", s), e.detachEvent("onload", s));
  }
  function s() {
    (mt.addEventListener ||
      "load" === event.type ||
  ...
  function c(e, t, n, r) {
    if (ot.acceptData(e)) {
      ...
      if (
        ...
        return (
          u || (u = s ? (e[a] = Y.pop() || ot.guid++) : a),
          l[u] || (l[u] = s ? {} : { toJSON: ot.noop }),
          ("object" == typeof t || "function" == typeof t) &&
          (r
            ? (l[u] = ot.extend(l[u], t))
            : (l[u].data = ot.extend(l[u].data, t))),
          (o = l[u]),
          r || (o.data || (o.data = {}), (o = o.data)),
          void 0 !== n && (o[ot.camelCase(t)] = n),
          "string" == typeof t
            ? ((i = o[t]), null == i && (i = o[ot.camelCase(t)]))
            : (i = o),
          i
        );
    }
    ...
    if (ot.acceptData(e)) {
      ...
      if (a[s]) {
        if (t && (r = n ? a[s] : a[s].data)) {
          ot.isArray(t)
            ? (t = t.concat(ot.map(t, ot.camelCase)))
            : t in r
              ? (t = [t])
              : ((t = ot.camelCase(t)), (t = t in r ? [t] : t.split(" "))),
            (i = t.length);
          for (; i--;) delete r[t[i]];
  ...
  function N(t, n) {
    var r,
      i = ot(n.createElement(t)).appendTo(n.body),
      o =
  ...
  function E(e) {
    ...
    return (
      ...
      ((n = N(e, t)),
        ("none" !== n && n) ||
        ((Kt = (
          Kt || ot("<iframe frameborder='0' width='0' height='0'/>")
  ...
  function A(e, t) {
    for (var n, r, i, o = [], a = 0, s = e.length; s > a; a++)
      (r = e[a]),
        r.style &&
        ((o[a] = ot._data(r, "olddisplay")),
          (n = r.style.display),
          t
            ? (o[a] || "none" !== n || (r.style.display = ""),
              "" === r.style.display &&
              Dt(r) &&
              (o[a] = ot._data(r, "olddisplay", E(r.nodeName))))
            : ((i = Dt(r)),
              ((n && "none" !== n) || !i) &&
              ot._data(r, "olddisplay", i ? n : ot.css(r, "display"))));
    for (a = 0; s > a; a++)
      (r = e[a]),
        r.style &&
  ...
  function j(e, t, n, r, i) {
    for (
      ...
      "margin" === n && (a += ot.css(e, n + At[o], !0, i)),
        r
          ? ("content" === n && (a -= ot.css(e, "padding" + At[o], !0, i)),
            "margin" !== n &&
            (a -= ot.css(e, "border" + At[o] + "Width", !0, i)))
          : ((a += ot.css(e, "padding" + At[o], !0, i)),
            "padding" !== n &&
            (a += ot.css(e, "border" + At[o] + "Width", !0, i)));
    return a;
  }
  ...
  function O(e, t, n) {
    ...
    n.queue ||
      ...
      ((n.overflow = [p.overflow, p.overflowX, p.overflowY]),
        (u = ot.css(e, "display")),
        (c = "none" === u ? ot._data(e, "olddisplay") || E(e.nodeName) : u),
        "inline" === c &&
        "none" === ot.css(e, "float") &&
        (rt.inlineBlockNeedsLayout && "inline" !== E(e.nodeName)
          ? (p.zoom = 1)
  ...
  function B(e, t, n) {
    ...
    return (
      ...
      ot.fx.timer(ot.extend(l, { elem: e, anim: u, queue: u.opts.queue })),
      u
  ...
  (ot.fn = ot.prototype =
  {
          ...
          if (null != (i = arguments[s]))
            for (r in i)
              (e = a[r]),
                (n = i[r]),
                a !== n &&
                (u && n && (ot.isPlainObject(n) || (t = ot.isArray(n)))
                  ? (t
                    ? ((t = !1), (o = e && ot.isArray(e) ? e : []))
                    : (o = e && ot.isPlainObject(e) ? e : {}),
                    (a[r] = ot.extend(u, o, n)))
                  : void 0 !== n && (a[r] = n));
        return a;
      }),
    ot.extend({
      ...
      isPlainObject: function (e) {
        ...
        if (rt.ownLast) for (t in e) return nt.call(e, t);
        for (t in e);
      ...
      makeArray: function (e, t) {
        ...
        return (
          null != e &&
          (n(Object(e))
            ? ot.merge(r, "string" == typeof e ? [e] : e)
            : K.call(r, e)),
          r
        );
      },
          ...
          return n !== H && 9 === n.nodeType && n.documentElement
            ? ((H = n),
              ...
              (T.find.CLASS =
                w.getElementsByClassName &&
                function (e, t) {
                  return typeof t.getElementsByClassName !== J && q
                    ? t.getElementsByClassName(e)
                    : void 0;
                }),
              (O = []),
              (M = []),
              (w.qsa = $.test(n.querySelectorAll)) &&
              (i(function (e) {
                (e.innerHTML =
                  ...
                  return r
                    ...
                    : ((r =
                      ...
                      1 & r ||
                        ...
                        ? e === n || (e.ownerDocument === R && B(R, e))
                          ? -1
                          : t === n || (t.ownerDocument === R && B(R, t))
                            ? 1
                            : D
      ...
      (t.matchesSelector = function (e, n) {
        if (
          ((e.ownerDocument || e) !== H && L(e),
            (n = n.replace(ft, "='$1']")),
            !(!w.matchesSelector || !q || (O && O.test(n)) || (M && M.test(n))))
        )
          try {
            var r = F.call(e, n);
            if (
      ...
      (S = t.select =
        function (e, t, n, r) {
          ...
          if (((n = n || []), 1 === d.length)) {
            ...
            for (
              i = mt.needsContext.test(e) ? 0 : o.length;
          ...
          return (
            (u || k(e, d))(r, t, !q, n, (bt.test(e) && c(t.parentNode)) || t), n
          );
        }),
  ...
  (ot.filter = function (e, t, n) {
    ...
    ot.fn.extend({
      ...
      is: function (e) {
        return !!r(
          this,
          "string" == typeof e && dt.test(e) ? ot(e) : e || [],
          !1
        ).length;
      },
    });
          ...
          if (
            ((t = t instanceof ot ? t[0] : t),
              ot.merge(
                ...
                ot.parseHTML(
                  n[1],
                  t && t.nodeType ? t.ownerDocument || t : mt,
                  !0
                )
              ),
              ft.test(n[1]) && ot.isPlainObject(t))
          )
            for (n in t)
  ...
  ot.extend({
    dir: function (e, t, n) {
      for (
        ...
        i &&
        9 !== i.nodeType &&
        (void 0 === n || 1 !== i.nodeType || !ot(i).is(n));
    ...
    ot.fn.extend({
      ...
      closest: function (e, t) {
        for (
          ...
          o = [],
          a =
            dt.test(e) || "string" != typeof e ? ot(e, t || this.context) : 0;
          i > r;
          r++
        )
      ...
      index: function (e) {
        return e
          ? "string" == typeof e
            ? ot.inArray(this[0], ot(e))
            : ot.inArray(e.jquery ? e[0] : e, this)
    ...
    ot.each(
      {
        ...
        contents: function (e) {
          return ot.nodeName(e, "iframe")
            ? e.contentDocument || e.contentWindow.document
            : ot.merge([], e.childNodes);
        },
      },
      function (e, t) {
        ot.fn[e] = function (n, r) {
          ...
          return (
            ...
            this.length > 1 &&
            (bt[e] || (i = ot.unique(i)), yt.test(e) && (i = i.reverse())),
            this.pushStack(i)
          );
        };
      }
    ...
    ot.extend({
      ...
      when: function (e) {
        var t = 0,
          n = G.call(arguments),
          r = n.length,
          i = 1 !== r || (e && ot.isFunction(e.promise)) ? r : 0,
          o = 1 === i ? e : ot.Deferred(),
          a = function (e, t, n) {
            return function (r) {
              (t[e] = this),
          ...
          u;
        if (r > 1)
          for (s = new Array(r), l = new Array(r), u = new Array(r); r > t; t++)
            n[t] && ot.isFunction(n[t].promise)
              ? n[t]
                .promise()
                .done(a(t, u, n))
                .fail(o.reject)
    ...
    ot.extend({
      ...
      ready: function (e) {
        if (e === !0 ? !--ot.readyWait : !ot.isReady) {
          ...
          (ot.isReady = !0),
            (e !== !0 && --ot.readyWait > 0) ||
            (Tt.resolveWith(mt, [ot]),
              ot.fn.triggerHandler &&
              (ot(mt).triggerHandler("ready"), ot(mt).off("ready")));
        }
      },
    }),
      ...
      (n = mt.getElementsByTagName("body")[0]),
        ...
        ((t = mt.createElement("div")),
          ...
          ((t.style.cssText =
            ...
            (rt.inlineBlockNeedsLayout = e = 3 === t.offsetWidth),
            e && (n.style.zoom = 1)),
          n.removeChild(r));
    }),
    (function () {
  ...
  ot.extend({
    ...
    hasData: function (e) {
      return (
        (e = e.nodeType ? ot.cache[e[ot.expando]] : e[ot.expando]), !!e && !u(e)
      );
    },
    data: function (e, t, n) {
      return c(e, t, n);
    ...
    ot.fn.extend({
      data: function (e, t) {
        ...
        if (void 0 === e) {
          if (
            this.length &&
            ((i = ot.data(o)), 1 === o.nodeType && !ot._data(o, "parsedAttrs"))
          ) {
            for (n = a.length; n--;)
              a[n] &&
                ((r = a[n].name),
                  0 === r.indexOf("data-") &&
                  ((r = ot.camelCase(r.slice(5))), l(o, r, i[r])));
  ...
  !(function () {
    ...
    if (
      ((t.innerHTML =
        ...
        (rt.leadingWhitespace = 3 === t.firstChild.nodeType),
        (rt.tbody = !t.getElementsByTagName("tbody").length),
        (rt.htmlSerialize = !!t.getElementsByTagName("link").length),
        (rt.html5Clone =
          "<:nav></:nav>" !== mt.createElement("nav").cloneNode(!0).outerHTML),
        (e.type = "checkbox"),
        (e.checked = !0),
        n.appendChild(e),
        (rt.appendChecked = e.checked),
    ...
    (function () {
      ...
      for (t in { submit: !0, change: !0, focusin: !0 })
        (n = "on" + t),
          (rt[t + "Bubbles"] = n in e) ||
          (r.setAttribute(n, "t"),
            (rt[t + "Bubbles"] = r.attributes[n].expando === !1));
      r = null;
    })();
  ...
  (ot.event = {
    ...
    trigger: function (t, n, r, i) {
      ...
      if (
        ...
        if (!i && !u.noBubble && !ot.isWindow(r)) {
          for (
            l = u.delegateType || p, $.test(l + p) || (s = s.parentNode);
            s;
            s = s.parentNode
          )
            f.push(s), (c = s);
          c === (r.ownerDocument || mt) &&
            f.push(c.defaultView || c.parentWindow || e);
        }
        for (d = 0; (s = f[d++]) && !t.isPropagationStopped();)
          (t.type = d > 1 ? l : u.bindType || p),
            (o =
              (ot._data(s, "events") || {})[t.type] && ot._data(s, "handle")),
            o && o.apply(s, n),
            (o = a && s[a]),
            o &&
            o.apply &&
    ...
    fix: function (e) {
      ...
      for (
        a ||
        (this.fixHooks[i] = a =
          qt.test(i) ? this.mouseHooks : _t.test(i) ? this.keyHooks : {}),
        ...
        (n = r[t]), (e[n] = o[n]);
      return (
        e.target || (e.target = o.srcElement || mt),
        ...
        return ot.nodeName(this, "form")
          ...
          : void ot.event.add(
            ...
            function (e) {
              var t = e.target,
                n =
                  ot.nodeName(t, "input") || ot.nodeName(t, "button")
                    ? t.form
                    : void 0;
              n &&
                !ot._data(n, "submitBubbles") &&
                (ot.event.add(n, "submit._submit", function (e) {
                  e._submit_bubble = !0;
                }),
      ...
      postDispatch: function (e) {
        e._submit_bubble &&
          (delete e._submit_bubble,
            this.parentNode &&
            !e.isTrigger &&
            ot.event.simulate("submit", this.parentNode, e, !0));
      },
      teardown: function () {
        return ot.nodeName(this, "form")
          ? !1
      ...
      setup: function () {
        return Ht.test(this.nodeName)
          ? (("checkbox" === this.type || "radio" === this.type) &&
            (ot.event.add(this, "propertychange._change", function (e) {
            ...
            !1)
          : void ot.event.add(this, "beforeactivate._change", function (e) {
            var t = e.target;
            Ht.test(t.nodeName) &&
              !ot._data(t, "changeBubbles") &&
              (ot.event.add(t, "change._change", function (e) {
                !this.parentNode ||
                  e.isSimulated ||
                  e.isTrigger ||
                  ot.event.simulate("change", this.parentNode, e, !0);
              }),
    ...
    ot.each({ focus: "focusin", blur: "focusout" }, function (e, t) {
      ...
      ot.event.special[t] = {
        ...
        teardown: function () {
          ...
          i
            ? ot._data(r, t, i)
            : (r.removeEventListener(e, n, !0), ot._removeData(r, t));
        },
      };
    }),
    ot.fn.extend({
  ...
  var Ot =
    ...
    Gt = m(mt),
    Qt = Gt.appendChild(mt.createElement("div"));
  (Yt.optgroup = Yt.option),
    ...
    ot.extend({
      clone: function (e, t, n) {
        ...
        if (
          (rt.html5Clone || ot.isXMLDoc(e) || !Bt.test("<" + e.nodeName + ">")
            ? (o = e.cloneNode(!0))
            : ((Qt.innerHTML = e.outerHTML),
              Qt.removeChild((o = Qt.firstChild))),
            !(
              (rt.noCloneEvent && rt.noCloneChecked) ||
      ...
      buildFragment: function (e, t, n, r) {
          ...
          if (((o = e[h]), o || 0 === o))
            if ("object" === ot.type(o)) ot.merge(p, o.nodeType ? [o] : o);
              ...
              for (
                ...
                s = s.lastChild;
              if (
                (!rt.leadingWhitespace &&
                  Pt.test(o) &&
                  p.push(t.createTextNode(Pt.exec(o)[0])),
                  !rt.tbody)
              )
                for (
                  o =
                  ...
                  ot.nodeName((u = o.childNodes[i]), "tbody") &&
                    !u.childNodes.length &&
                    o.removeChild(u);
              for (
                ot.merge(p, s.childNodes), s.textContent = "";
                s.firstChild;
        ...
        for (
          s && f.removeChild(s),
          rt.appendChecked || ot.grep(g(p, "input"), v),
          h = 0;
          (o = p[h++]);
          ...
          if (
            (!r || -1 === ot.inArray(o, r)) &&
            ((a = ot.contains(o.ownerDocument, o)),
    ...
    ot.fn.extend({
        ...
        return jt(
          ...
          function (e) {
            return void 0 === e
              ? ot.text(this)
              : this.empty().append(
                ((this[0] && this[0].ownerDocument) || mt).createTextNode(e)
              );
          },
          null,
          e,
      ...
      remove: function (e, t) {
        for (
          var n, r = e ? ot.filter(e, this) : this, i = 0;
          null != (n = r[i]);
          i++
        )
          t || 1 !== n.nodeType || ot.cleanData(g(n)),
            n.parentNode &&
            (t && ot.contains(n.ownerDocument, n) && w(g(n, "script")),
          ...
          function (e) {
            ...
            if (
              !(
                "string" != typeof e ||
                It.test(e) ||
                (!rt.htmlSerialize && Bt.test(e)) ||
                (!rt.leadingWhitespace && Pt.test(e)) ||
              ...
              try {
                for (; r > n; n++)
                  (t = this[n] || {}),
                    1 === t.nodeType &&
                    (ot.cleanData(g(t, !1)), (t.innerHTML = e));
                t = 0;
              } catch (i) { }
            }
      ...
      domManip: function (e, t) {
        ...
        if (
          p ||
          (u > 1 && "string" == typeof f && !rt.checkClone && Xt.test(f))
        )
        ...
        if (
          u &&
          ((s = ot.buildFragment(e, this[0].ownerDocument, !1, this)),
            (n = s.firstChild),
          ...
          for (o = ot.map(g(s, "script"), b), i = o.length; u > l; l++)
            (r = s),
              l !== d &&
              ((r = ot.clone(r, !0, !0)), i && ot.merge(o, g(r, "script"))),
              t.call(this[l], r, l);
          if (i)
            for (
              a = o[o.length - 1].ownerDocument, ot.map(o, x), l = 0;
              i > l;
              l++
            )
              (r = o[l]),
                Ut.test(r.type || "") &&
                !ot._data(r, "globalEval") &&
                ot.contains(a, r) &&
                (r.src
                  ? ot._evalUrl && ot._evalUrl(r.src)
                  : ot.globalEval(
        ...
        n && n.style
          ? ((t = mt.createElement("div")),
            ...
            ((t.style.cssText =
              ...
              (t.appendChild(mt.createElement("div")).style.width = "5px"),
              (e = 3 !== t.offsetWidth)),
            n.removeChild(r),
            e)
          : void 0
    ...
    !(function () {
        ...
        (n = mt.getElementsByTagName("body")[0]),
          ...
          ((t = mt.createElement("div")),
            ...
            ((o = "1%" !== (e.getComputedStyle(t, null) || {}).top),
              ...
              (i = t.appendChild(mt.createElement("div"))),
      ...
      (n = mt.createElement("div")),
        ...
        ((r.cssText = "float:left;opacity:.5"),
          (rt.opacity = "0.5" === r.opacity),
          (rt.cssFloat = !!r.cssFloat),
  ...
  ot.extend({
    ...
    style: function (e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var i,
          ...
          l = e.style;
        if (
          ((t = ot.cssProps[s] || (ot.cssProps[s] = S(l, s))),
        ...
        if (
          ((o = typeof n),
            "string" === o &&
            (i = cn.exec(n)) &&
            ((n = (i[1] + 1) * i[2] + parseFloat(ot.css(e, t))),
              (o = "number")),
            null != n &&
            n === n &&
            ("number" !== o || ot.cssNumber[s] || (n += "px"),
              rt.clearCloneStyle ||
              "" !== n ||
    ...
    css: function (e, t, n, r) {
      var i,
        ...
        s = ot.camelCase(t);
      return (
        (t = ot.cssProps[s] || (ot.cssProps[s] = S(e.style, s))),
        (a = ot.cssHooks[t] || ot.cssHooks[s]),
        a && "get" in a && (o = a.get(e, !0, n)),
        void 0 === o && (o = rn(e, t, r)),
        "normal" === o && t in fn && (o = fn[t]),
        "" === n || n
          ? ((i = parseFloat(o)), n === !0 || ot.isNumeric(i) ? i || 0 : o)
          : o
      );
    },
  }),
    ot.each(["height", "width"], function (e, t) {
      ot.cssHooks[t] = {
        get: function (e, n, r) {
          return n
            ? ln.test(ot.css(e, "display")) && 0 === e.offsetWidth
              ? ot.swap(e, dn, function () {
                return L(e, t, r);
              })
              : L(e, t, r)
            : void 0;
          ...
          return D(
            ...
            r
              ? j(
                ...
                r,
                rt.boxSizing &&
                "border-box" === ot.css(e, "boxSizing", !1, i),
                i
              )
              : 0
          );
    ...
    (ot.cssHooks.marginRight = k(rt.reliableMarginRight, function (e, t) {
      return t
        ? ot.swap(e, { display: "inline-block" }, rn, [e, "marginRight"])
        : void 0;
    })),
    ot.each({ margin: "", padding: "", border: "Width" }, function (e, t) {
      (ot.cssHooks[e + t] = {
        ...
        en.test(e) || (ot.cssHooks[e + t].set = D);
    }),
    ot.fn.extend({
      css: function (e, t) {
        return jt(
      ...
      "*": [
        function (e, t) {
          var n = this.createTween(e, t),
            ...
            a =
              (ot.cssNumber[e] || ("px" !== o && +r)) &&
              vn.exec(ot.css(n.elem, e)),
            s = 1,
            l = 20;
          if (a && a[3] !== o) {
            (o = o || a[3]), (i = i || []), (a = +r || 1);
  ...
  (ot.Animation = ot.extend(B, {
    ...
    (function () {
      ...
      (t = mt.createElement("div")),
        ...
        (rt.getSetAttribute = "t" !== t.className),
        (rt.style = /top/.test(r.getAttribute("style"))),
        (rt.hrefNormalized = "/a" === r.getAttribute("href")),
        (rt.checkOn = !!e.value),
        (rt.optSelected = i.selected),
        (rt.enctype = !!mt.createElement("form").enctype),
        (n.disabled = !0),
        (rt.optDisabled = !i.disabled),
        (e = mt.createElement("input")),
        e.setAttribute("value", ""),
        (rt.input = "" === e.getAttribute("value")),
        (e.value = "t"),
  ...
  ot.fn.extend({
      ...
      return arguments.length
        ? ((r = ot.isFunction(e)),
          this.each(function (n) {
            var i;
            1 === this.nodeType &&
              ((i = r ? e.call(this, n, ot(this).val()) : e),
                null == i
                  ? (i = "")
                  : "number" == typeof i
                    ? (i += "")
                    : ot.isArray(i) &&
                    (i = ot.map(i, function (e) {
                      return null == e ? "" : e + "";
                    })),
                (t =
        ...
        : i
          ? ((t = ot.valHooks[i.type] || ot.valHooks[i.nodeName.toLowerCase()]),
    ...
    ot.extend({
      valHooks: {
        ...
        select: {
          ...
          set: function (e, t) {
            for (
              var n, r, i = e.options, o = ot.makeArray(t), a = i.length;
              a--;
    ...
    ot.each(["radio", "checkbox"], function () {
      (ot.valHooks[this] = {
        set: function (e, t) {
          return ot.isArray(t)
            ? (e.checked = ot.inArray(ot(e).val(), t) >= 0)
            : void 0;
        },
      }),
        rt.checkOn ||
        ...
        return e && 3 !== o && 8 !== o && 2 !== o
          ? typeof e.getAttribute === Ct
            ...
            : ((1 === o && ot.isXMLDoc(e)) ||
              ((t = t.toLowerCase()),
                (r =
                  ot.attrHooks[t] || (ot.expr.match.bool.test(t) ? Cn : Tn))),
              void 0 === n
          ...
          for (; (n = o[i++]);)
            (r = ot.propFix[n] || n),
              ot.expr.match.bool.test(n)
                ? (Sn && kn) || !En.test(n)
                  ? (e[r] = !1)
                  : (e[ot.camelCase("default-" + n)] = e[r] = !1)
                : ot.attr(e, n, ""),
      ...
      set: function (e, t, n) {
        return (
          t === !1
            ? ot.removeAttr(e, n)
            : (Sn && kn) || !En.test(n)
              ? e.setAttribute((!kn && ot.propFix[n]) || n, n)
              : (e[ot.camelCase("default-" + n)] = e[n] = !0),
          n
        );
      },
    }),
        ...
        : this.each(
          ot.isFunction(e)
            ...
            : function () {
              if ("string" === n)
                for (
                  var t, r = 0, i = ot(this), o = e.match(xt) || [];
                  (t = o[r++]);
  ...
  try {
    ...
    (Mn = mt.createElement("a")), (Mn.href = ""), (Mn = Mn.href);
  }
  (qn = $n.exec(Mn.toLowerCase()) || []),
    ot.extend({
      ...
      ajax: function (e, t) {
        ...
        (l = d.global),
          ...
          d.ifModified &&
          (ot.lastModified[o] &&
            w.setRequestHeader("If-Modified-Since", ot.lastModified[o]),
    ...
    ot.each(["get", "post"], function (e, t) {
      ot[t] = function (e, n, r, i) {
        return (
          ...
          ot.ajax({ url: e, type: t, dataType: i, data: n, success: r })
        );
      };
    }),
    ot.each(
    ...
    (ot.expr.filters.hidden = function (e) {
      return (
        ...
        (!rt.reliableHiddenOffsets() &&
          "none" === ((e.style && e.style.display) || ot.css(e, "display")))
      );
    }),
  ...
  var Kn = 0,
    Zn = {},
    er = ot.ajaxSettings.xhr();
  e.ActiveXObject &&
    ot(e).on("unload", function () {
      for (var e in Zn) Zn[e](void 0, !0);
    }),
    (rt.cors = !!er && "withCredentials" in er),
    (er = rt.ajax = !!er),
    er &&
  ...
  (ot.fn.load = function (e, t, n) {
    ...
    var r,
      ...
      s = e.indexOf(" ");
    return (
      s >= 0 && ((r = ot.trim(e.slice(s, e.length))), (e = e.slice(0, s))),
      ot.isFunction(t)
        ? ((n = t), (t = void 0))
  ...
  (ot.offset = {
    ...
    ot.each(["top", "left"], function (e, t) {
      ot.cssHooks[t] = k(rt.pixelPosition, function (e, n) {
        return n
          ? ((n = rn(e, t)), tn.test(n) ? ot(e).position()[t] + "px" : n)
          : void 0;
      });
    }),
  ...
  return (
    (ot.noConflict = function (t) {
      return (
        e.$ === ot && (e.$ = ar), t && e.jQuery === ot && (e.jQuery = or), ot
      );
    }),
